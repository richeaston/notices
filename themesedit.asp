...
' Define page object
Dim Themes_edit
Set Themes_edit = New cThemes_edit
Set Page = Themes_edit

' Page init processing
Call Themes_edit.Page_Init()

' Page main processing
Call Themes_edit.Page_Main()
%>
...
Themes_edit.FormID = "fThemesedit"; // form ID
var EW_PAGE_ID = Themes_edit.PageID; // for backward compatibility
// extend page with ValidateForm function
Themes_edit.ValidateForm = function(fobj) {
...
Themes_edit.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!
 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
Themes_edit.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
}
<% If EW_CLIENT_VALIDATE Then %>
Themes_edit.ValidateRequired = true; // uses JavaScript validation
<% Else %>
Themes_edit.ValidateRequired = false; // no JavaScript validation
<% End If %>
//-->
</script>
<script type="text/javascript">
...
<% Themes_edit.ShowPageHeader() %>
<p class="aspmaker ewTitle"><%= Language.Phrase("Edit") %>&nbsp;<%= Language.Phrase("TblTypeTABLE") %><%= Themes.TableCaption %></p>
<p class="aspmaker"><a href="<%= Themes.ReturnUrl %>"><%= Language.Phrase("GoBack") %></a></p>
<% Themes_edit.ShowMessage %>
<form name="fThemesedit" id="fThemesedit" action="<%= ew_CurrentPage %>" method="post" onsubmit="return Themes_edit.ValidateForm(this);">
<p>
<input type="hidden" name="a_table" id="a_table" value="Themes">
...
<div<%= Themes.Theme_Name.ViewAttributes %>><%= Themes.Theme_Name.EditValue %></div>
<input type="hidden" name="x_Theme_Name" id="x_Theme_Name" value="<%= Server.HTMLEncode(Themes.Theme_Name.CurrentValue&"") %>">
...
Class cThemes_edit
	...
	Sub Page_Main()
		...
		If ObjForm.GetValue("a_edit")&"" <> "" Then
			Themes.CurrentAction = ObjForm.GetValue("a_edit") ' Get action code
			Call LoadFormValues() ' Get form values

			' Validate Form
			If Not ValidateForm() Then
				Themes.CurrentAction = "" ' Form error, reset action
			...
			End If
		Else
			Themes.CurrentAction = "I" ' Default action is display
		End If

		' Check if valid key
		If Themes.Theme_Name.CurrentValue = "" Then Call Page_Terminate("themeslist.asp") ' Invalid key, return to list
		Select Case Themes.CurrentAction
			Case "I" ' Get a record to display
				...
				End If
			Case "U" ' Update
				Themes.SendEmail = True ' Send email on update success
		...
		' Render the record
		Themes.RowType = EW_ROWTYPE_EDIT ' Render as edit
	...
	Sub RenderRow()
		...
		ElseIf Themes.RowType = EW_ROWTYPE_EDIT Then ' Edit row

			' Theme_Name
			Themes.Theme_Name.EditCustomAttributes = ""
			Themes.Theme_Name.EditValue = Themes.Theme_Name.CurrentValue
			Themes.Theme_Name.ViewCustomAttributes = ""
	...
	Function EditRow()
		...
		Else
			...
			bUpdateRow = Themes.Row_Updating(RsOld, Rs)
			If bUpdateRow Then
		...
		If EditRow Then
			Call Themes.Row_Updated(RsOld, RsNew)
		End If
		Rs.Close
		Set Rs = Nothing
