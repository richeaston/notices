...
' ASPMaker configuration for Table Notices
Dim Notices
...
Class cNotices
	...
	Public Property Get HighlightName()
		HighlightName = "Notices_Highlight"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "noticeslist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "noticeslist.asp"
	End Function

	' View url
	Public Function ViewUrl()
		ViewUrl = KeyUrl("noticesview.asp", UrlParm(""))
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("noticesedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("noticesadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("noticesdelete.asp", UrlParm(""))
	End Function
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					...
					Call XmlDoc.AddField("Approved", Approved.ExportValue(Export, ExportOriginalValue))
					Call XmlDoc.AddField("Archived", Archived.ExportValue(Export, ExportOriginalValue))
				Else
					Call XmlDoc.AddField("Title", Title.ExportValue(Export, ExportOriginalValue))
					Call XmlDoc.AddField("Author", Author.ExportValue(Export, ExportOriginalValue))
					Call XmlDoc.AddField("Sdate", Sdate.ExportValue(Export, ExportOriginalValue))
	...
	Public Sub ExportDocument(Doc, Recordset, StartRec, StopRec, ExportPageType)
		...
		If Doc.Horizontal Then ' Horizontal format, write header
			...
			If ExportPageType = "view" Then
				...
				Call Doc.ExportCaption(Approved)
				Call Doc.ExportCaption(Archived)
			Else
				Call Doc.ExportCaption(Title)
				Call Doc.ExportCaption(Author)
				Call Doc.ExportCaption(Sdate)
		...
		Do While Not Recordset.Eof And CLng(RecCnt) < CLng(StopRec)
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					...
					Call Doc.ExportField(Approved)
					Call Doc.ExportField(Archived)
				Else
					Call Doc.ExportField(Title)
					Call Doc.ExportField(Author)
					Call Doc.ExportField(Sdate)
...
'			End If
	...
	Public Property Get Notice_ID()
		If Not IsObject(m_Notice_ID) Then
			Set m_Notice_ID = NewFldObj("Notices", "Notices", "x_Notice_ID", "Notice_ID", "[Notice_ID]", 3, 7, "", False, False, "FORMATTED TEXT")
	...
	Public Property Get Title()
		If Not IsObject(m_Title) Then
			Set m_Title = NewFldObj("Notices", "Notices", "x_Title", "Title", "[Title]", 202, 7, "", False, False, "FORMATTED TEXT")
		End If
		Set Title = m_Title
	End Property
	...
	Public Property Get Author()
		If Not IsObject(m_Author) Then
			Set m_Author = NewFldObj("Notices", "Notices", "x_Author", "Author", "[Author]", 202, 7, "", False, False, "FORMATTED TEXT")
		End If
		Set Author = m_Author
	End Property
	...
	Public Property Get Sdate()
		If Not IsObject(m_Sdate) Then
			Set m_Sdate = NewFldObj("Notices", "Notices", "x_Sdate", "Sdate", "[Sdate]", 135, 7, "", False, False, "FORMATTED TEXT")
	...
	Public Property Get Edate()
		If Not IsObject(m_Edate) Then
			Set m_Edate = NewFldObj("Notices", "Notices", "x_Edate", "Edate", "[Edate]", 135, 7, "", False, False, "FORMATTED TEXT")
	...
	Public Property Get Group()
		If Not IsObject(m_Group) Then
			Set m_Group = NewFldObj("Notices", "Notices", "x_Group", "Group", "[Group]", 202, 7, "", False, False, "FORMATTED TEXT")
		End If
		Set Group = m_Group
	End Property
	...
	Public Property Get Notice()
		If Not IsObject(m_Notice) Then
			Set m_Notice = NewFldObj("Notices", "Notices", "x_Notice", "Notice", "[Notice]", 203, 7, "", False, False, "FORMATTED TEXT")
	...
	Public Property Get Approved()
		If Not IsObject(m_Approved) Then
			Set m_Approved = NewFldObj("Notices", "Notices", "x_Approved", "Approved", "[Approved]", 11, 7, "", False, False, "FORMATTED TEXT")
	...
	Public Property Get Archived()
		If Not IsObject(m_Archived) Then
			Set m_Archived = NewFldObj("Notices", "Notices", "x_Archived", "Archived", "[Archived]", 11, 7, "", False, False, "FORMATTED TEXT")
