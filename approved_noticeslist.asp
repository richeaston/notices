...
<br>
<div class="well">
	<div  id="myCarousel" class="carousel slide" data-interval="40000" data-pause='hover' rel='tooltip' title='Paused, to continue move the mouse.'>
		  <div class="carousel-inner" data-interval="40000" data-pause='hover'>
...
%>
		    	<% if strcount = 0 then %>
					<div class='item active' data-pause='hover'>
				<% else %>
					<div class='item' data-pause='hover'>
				<% end if %>
				<h2><%= Approved_Notices.Title.ListViewValue %></h2>
				<P><span class="label description"><%= Approved_Notices.Author.FldCaption %></span>&nbsp;<%= Approved_Notices.Author.ListViewValue %></p>
				...
				<strong><%= Approved_Notices.Notice.ListViewValue %></strong>
				</div>
	<%
	End If
	If Approved_Notices.CurrentAction <> "gridadd" Then
