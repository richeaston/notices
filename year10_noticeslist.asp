...
<!--#include file="year10_noticesinfo.asp"-->
...
<div class="row-fluid">
<h1 class="yeartitle">Year 10 Notices</h1>
		  <div>
...
%>
		    	<div class="frogitem">
				<h3><%= Approved_Notices.Title.ListViewValue %></h3>
				...
				<h4><%= Approved_Notices.Notice.ListViewValue %></h4>
				</div>
	<%
	End If
	If Approved_Notices.CurrentAction <> "gridadd" Then
