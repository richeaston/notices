...
' ASPMaker configuration for Table Unapproved Notices
Dim Unapproved_Notices

' Define table class
Class cUnapproved_Notices
	...
	Public Property Get HighlightName()
		HighlightName = "Unapproved_Notices_Highlight"
	End Property
	...
	Public Property Get SqlSelect() ' Select
		SqlSelect = "SELECT * FROM [Unapproved Notices]"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "unapproved_noticeslist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "unapproved_noticeslist.asp"
	End Function

	' View url
	Public Function ViewUrl()
		ViewUrl = KeyUrl("unapproved_noticesview.asp", UrlParm(""))
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("unapproved_noticesedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("unapproved_noticesadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("unapproved_noticesdelete.asp", UrlParm(""))
	End Function
...
'			End If
	...
	Public Property Get Notice_ID()
		If Not IsObject(m_Notice_ID) Then
			Set m_Notice_ID = NewFldObj("Unapproved_Notices", "Unapproved Notices", "x_Notice_ID", "Notice_ID", "[Notice_ID]", 3, 7, "", False, False, "FORMATTED TEXT")
	...
	Public Property Get Title()
		If Not IsObject(m_Title) Then
			Set m_Title = NewFldObj("Unapproved_Notices", "Unapproved Notices", "x_Title", "Title", "[Title]", 202, 7, "", False, False, "FORMATTED TEXT")
		End If
		Set Title = m_Title
	End Property
	...
	Public Property Get Author()
		If Not IsObject(m_Author) Then
			Set m_Author = NewFldObj("Unapproved_Notices", "Unapproved Notices", "x_Author", "Author", "[Author]", 202, 7, "", False, False, "FORMATTED TEXT")
		End If
		Set Author = m_Author
	End Property
	...
	Public Property Get Sdate()
		If Not IsObject(m_Sdate) Then
			Set m_Sdate = NewFldObj("Unapproved_Notices", "Unapproved Notices", "x_Sdate", "Sdate", "[Sdate]", 135, 7, "", False, False, "FORMATTED TEXT")
	...
	Public Property Get Edate()
		If Not IsObject(m_Edate) Then
			Set m_Edate = NewFldObj("Unapproved_Notices", "Unapproved Notices", "x_Edate", "Edate", "[Edate]", 135, 7, "", False, False, "FORMATTED TEXT")
	...
	Public Property Get Group()
		If Not IsObject(m_Group) Then
			Set m_Group = NewFldObj("Unapproved_Notices", "Unapproved Notices", "x_Group", "Group", "[Group]", 202, 7, "", False, False, "FORMATTED TEXT")
		End If
		Set Group = m_Group
	End Property
	...
	Public Property Get Notice()
		If Not IsObject(m_Notice) Then
			Set m_Notice = NewFldObj("Unapproved_Notices", "Unapproved Notices", "x_Notice", "Notice", "[Notice]", 203, 7, "", False, False, "FORMATTED TEXT")
	...
	Public Property Get Approved()
		If Not IsObject(m_Approved) Then
			Set m_Approved = NewFldObj("Unapproved_Notices", "Unapproved Notices", "x_Approved", "Approved", "[Approved]", 11, 7, "", False, False, "FORMATTED TEXT")
	...
	Public Property Get Archived()
		If Not IsObject(m_Archived) Then
			Set m_Archived = NewFldObj("Unapproved_Notices", "Unapproved Notices", "x_Archived", "Archived", "[Archived]", 11, 7, "", False, False, "FORMATTED TEXT")
