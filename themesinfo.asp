...
' ASPMaker configuration for Table Themes
Dim Themes
...
Class cThemes
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "Theme_Name", Theme_Name)
	End Sub
	...
	Public Property Get HighlightName()
		HighlightName = "Themes_Highlight"
	End Property
	...
	Private Property Get SqlKeyFilter()
		SqlKeyFilter = "[Theme_Name] = '@Theme_Name@'"
	End Property
	...
	Public Property Get KeyFilter()
		...
		sKeyFilter = Replace(sKeyFilter, "@Theme_Name@", ew_AdjustSql(Theme_Name.CurrentValue)) ' Replace key value
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "themeslist.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "themeslist.asp"
	End Function

	' View url
	Public Function ViewUrl()
		ViewUrl = KeyUrl("themesview.asp", UrlParm(""))
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("themesedit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("themesadd.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("themesdelete.asp", UrlParm(""))
	End Function
	...
	Public Function KeyUrl(url, parm)
		...
		If Not IsNull(Theme_Name.CurrentValue) Then
			sUrl = sUrl & "Theme_Name=" & Server.URLEncode(Theme_Name.CurrentValue)
		Else
	...
	Public Function GetRecordKeys()
		...
		If Not bHasKey Then
			...
			ElseIf Request.QueryString <> "" Then
				ReDim arKeys(0)
				arKeys(0) = Request.QueryString("Theme_Name") ' Theme_Name
	...
	Public Sub LoadListRowValues(RsRow)
		Theme_Name.DbValue = RsRow("Theme_Name")
	End Sub
	...
	Sub RenderListRow()
		...
		Theme_Name.ViewValue = Theme_Name.CurrentValue
		Theme_Name.ViewCustomAttributes = ""

		' Theme_Name
		Theme_Name.LinkCustomAttributes = ""
		Theme_Name.HrefValue = ""
		Theme_Name.TooltipValue = ""
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					Call XmlDoc.AddField("Theme_Name", Theme_Name.ExportValue(Export, ExportOriginalValue))
				Else
					Call XmlDoc.AddField("Theme_Name", Theme_Name.ExportValue(Export, ExportOriginalValue))
				End If
			End If
	...
	Public Sub ExportDocument(Doc, Recordset, StartRec, StopRec, ExportPageType)
		...
		If Doc.Horizontal Then ' Horizontal format, write header
			...
			If ExportPageType = "view" Then
				Call Doc.ExportCaption(Theme_Name)
			Else
				Call Doc.ExportCaption(Theme_Name)
			End If
		...
		Do While Not Recordset.Eof And CLng(RecCnt) < CLng(StopRec)
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					Call Doc.ExportField(Theme_Name)
				Else
					Call Doc.ExportField(Theme_Name)
				End If
				Call Doc.EndExportRow()
...
'			End If
	...
	' ----------------
	' Field Theme_Name
	Private m_Theme_Name

	Public Property Get Theme_Name()
		If Not IsObject(m_Theme_Name) Then
			Set m_Theme_Name = NewFldObj("Themes", "Themes", "x_Theme_Name", "Theme_Name", "[Theme_Name]", 202, 7, "", False, False, "FORMATTED TEXT")
		End If
		Set Theme_Name = m_Theme_Name
	End Property
	Dim Fields ' Fields
	...
	Private Sub Class_Terminate
		If IsObject(m_Theme_Name) Then Set m_Theme_Name = Nothing
